...
class TestImageDeconvolution(unittest.TestCase):
    ...
    def test_restore(self):
        ...
        assert (
            numpy.abs(numpy.max(self.cmodel["pixels"].data) - 1.0) < 1e-7
    ...
    def test_restore_skycomponent(self):
        ...
        assert (
            numpy.abs(
                numpy.max(self.cmodel["pixels"].data) - 0.9959046879055156
            )
            < 1e-7
        ), numpy.max(self.cmodel["pixels"].data)
    ...
    def test_deconvolve_hogbom_subpsf(self):
        ...
        assert (
            numpy.max(self.residual["pixels"].data[..., 56:456, 56:456]) < 1.2
        )
    ...
    def test_deconvolve_msclean_subpsf(self):
        ...
        assert (
            numpy.max(self.residual["pixels"].data[..., 56:456, 56:456]) < 1.0
        )
    ...
    def test_hogbom_kernel_list_single_dirty(self):
        ...
        self._check_hogbom_kernel_list_test_results(
